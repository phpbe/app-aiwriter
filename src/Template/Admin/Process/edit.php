            ...
            <div class="be-p-150 be-bc-fff">
                ...
                <div class="be-row be-mt-100">
                    ...
                    <div class="be-col-24 be-md-col">
                        ...
                        <?php $formData['name'] = ($this->process ? $this->process->material_category_id : ''); ?>
                    </div>
                </div>
            </div>
                    ...
                    <div class="be-col-24 be-md-col">
                        ...
                        <div class="be-mt-100">
                            ...
                            <el-select @change="insertTemplate('title')" v-model = "template.title">
                                <el-option value="改写以下内容，让它更符合SEO，更吸引用户：<br>{素材标题}">改写以下内容，让它更符合SEO，更吸引用户：{素材标题}</el-option>
                            </el-select>
                        </div>
                    </div>
                </div>
